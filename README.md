...
- ✅ **P0 — Fundament (8/9):** settings split · Redis · Celery+Beat · Docker · logging · health · requirements · pre-commit *(qolgan: sirlar rotatsiyasi)*
- 🔄 **P1 — Data model (3/7):** ✅ rasm→Celery · ✅ Season · ✅ WatchProgress *(keyingi: Coin ledger, rating birlashtirish, publish-workflow, custom User)*
- ⏳ **P2** DRF REST API · **P3** Celery jobs (Bunny upload, bildirishnoma) · **P4** video xavfsizligi (signed URL) · **P5** frontend (HTMX/Alpine/SEO) · **P6** auth · **P7** monetizatsiya (Payme/Click) · **P8** qidiruv (PostgreSQL FTS) · **P9** performans · **P10** xavfsizlik · … **P14** deploy
