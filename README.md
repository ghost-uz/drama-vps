...
Reja ikki tracker'da: `drama_tasks.json` (v1: 15 faza / 65 task — **59 done**) va `drama-vps-v2_tasks.json` (v2: 8 faza / 32 task — **1 done**: V2A-T1 yangi-qism bildirishnomasi). Bosqichlar va ustuvorlik: **`roadmap.md`** (2026-07-10 audit: arxitektura **82/100** · UX **76/100**).
